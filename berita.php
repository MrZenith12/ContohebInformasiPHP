...
<section class="upcoming-meetings" id="meetings">
    <div class="container">
        <div class="row">
            ...
            // Hitung jumlah total berita dari tabel tbl_berita
            $sql_total_berita = "SELECT COUNT(*) AS total FROM tbl_berita";
            $result_total_berita = $koneksi->query($sql_total_berita);
            $total_berita = $result_total_berita->fetch_assoc()['total'];
            $berita_per_halaman = 6; // Jumlah berita yang ingin ditampilkan per halaman
            ...
            // Query untuk mengambil berita terbaru dari tabel tbl_berita dengan offset dan limit sesuai halaman yang diminta
            $sql = "SELECT * FROM tbl_berita ORDER BY tanggal_dimasukkan DESC LIMIT $berita_per_halaman OFFSET $offset";
