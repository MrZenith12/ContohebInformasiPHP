    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
          <?php
            // Mendapatkan id_jurusan dari parameter URL
            $id_jurusan = $_GET['id_jurusan'];

            // Kode query untuk mengambil data berita yang dipilih
            $query = "SELECT * FROM tbl_jurusan WHERE id_jurusan = '$id_jurusan'";
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                <div class="thumb">
                  ...
                  <?php
                    ...
                    if ($ekstensi === 'jpg' || $ekstensi === 'jpeg' || $ekstensi === 'png') {
                        ...
                        echo '<a href="#"><img src="../admin/foto/' . $gambar . '" alt=""></a>';
                    }else {
                ...
                <div class="down-content">
                  <a href="meeting-details.php"><h4><?php echo $namajurusan; ?></h4></a>
                  <p class="description">
                    <?php echo $deskripsi; ?>
                  </p>
                </div>
