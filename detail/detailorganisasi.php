    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
          <?php
            // Mendapatkan id_organisasi dari parameter URL
            $id_organisasi = $_GET['id_organisasi'];

            // Kode query untuk mengambil data berita yang dipilih
            $query = "SELECT * FROM tbl_organisasi WHERE id_organisasi = '$id_organisasi'";
            $result = mysqli_query($koneksi, $query);

            // Memeriksa apakah data berita ditemukan
            if (mysqli_num_rows($result) > 0) {
                $row = mysqli_fetch_assoc($result);
                $image = $row['gambar_organisasi'];
                $nama_oragnisasi = $row['nama_oragnisasi'];
                $tanggal = $row['tanggal'];
            ...
            <div class="col-lg-12">
              <div class="meeting-single-item">
                ...
                <div class="down-content">
                  <a href="#"><h4><?php echo $nama_oragnisasi; ?></h4></a>
                  <p class="description">
                    <?php echo $deskripsi; ?>
                  </p>
                </div>
            ...
            <div class="col-lg-12">
              <div class="main-button-red">
                <a href="../gallery.php">Kembali Ke Halaman Ekskul</a>
              </div>
            </div>
          </div>
        </div>
